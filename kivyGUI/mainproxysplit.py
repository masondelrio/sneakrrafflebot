...
class ContentNavigationDrawer(BoxLayout):
    ...
    def splitProxy(self):
        ...
        fproxy1 = self.proxy1.text
        fproxy1 = re.split(':', self.proxy1.text)

        self.pHost = fproxy1[0]
        self.pPort = fproxy1[1]
        self.pUser = fproxy1[2]
        self.pPass = fproxy1[3]
        print(fproxy1)
        return self.pHost, self.pPort, self.pUser, self.pPass
    ...
    def audioToText(mp3Path):
        ...
        text = driver.find_element(By.XPATH, '//*[@id="root"]/div/div[6]/div/div/dialog').find_elements_by_tag_name(
            'dd')
    ...
    def testproxy(self):
        ...
        """ % (self.pHost, self.pPort, self.pUser, self.pPass)
